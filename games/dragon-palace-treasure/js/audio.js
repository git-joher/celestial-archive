...
var AudioEngine = (function () {
  ...
  // Pentatonic scale — underwater / ambient, lower and more mysterious
  var PENTATONIC = [110, 130, 165, 196, 220, 262, 330, 392, 440, 524, 660, 784];

  // Intensity configs
  var CONFIG = {
    calm:  { bpm: 60,  bassVol: 0.10, droneVol: 0.08, melodyVol: 0.06, drumVol: 0.02, drumPattern: 'simple' },
    tense: { bpm: 100, bassVol: 0.15, droneVol: 0.12, melodyVol: 0.10, drumVol: 0.06, drumPattern: 'double' },
    boss:  { bpm: 140, bassVol: 0.22, droneVol: 0.16, melodyVol: 0.14, drumVol: 0.12, drumPattern: 'heavy' }
  };
  ...
  function playSfx(name) {
    ...
    switch (name) {
      case 'attack':
        playNoiseHit(0.06, 600, 150, 0.2); // water slash
        break;
      case 'hurt':
        playNoiseHit(0.1, 150, 40, 0.25); // deep thud
        break;
      case 'kill_metal':
        playToneSweep(400, 100, 0.1, 'sine', 0.12); // bubble burst low
        break;
      case 'kill_wood':
        playNoiseHit(0.05, 300, 200, 0.1); // bubble pop
        break;
      case 'kill_water':
        playToneSweep(600, 80, 0.12, 'sine', 0.1);
        playNoiseHit(0.03, 800, 150, 0.06);
        break;
      case 'kill_fire':
        playNoiseBurst(0.15, 0.14);
        break;
      case 'kill_earth':
        playNoiseHit(0.12, 80, 30, 0.2);
        break;
      case 'levelup':
        playLevelUp();
        break;
      case 'death':
        playToneSweep(100, 20, 1.5, 'sine', 0.3); // deep descending — sinking/crushing
        playNoiseHit(0.8, 60, 15, 0.25); // rumble
        break;
      case 'jump':
        playToneSweep(800, 1200, 0.08, 'sine', 0.15); // collect treasure ding
        break;
      case 'fiery':
        for (var bi = 0; bi < 3; bi++) { // ascending bubbles — oxygen refill
          playToneSweep(300 + bi * 150, 500 + bi * 200, 0.1, 'sine', 0.08);
        }
        break;
      case 'stun':
        playToneSweep(200, 40, 0.6, 'triangle', 0.2); // whirlpool descent
        playNoiseHit(0.5, 100, 20, 0.15);
        break;
      case 'shockwave':
        playNoiseBurst(0.6, 0.35); // boss roar
        playToneSweep(80, 20, 0.5, 'sawtooth', 0.3);
        break;
      // ── New underwater SFX names ──
      case 'collect':
        playToneSweep(800, 1200, 0.08, 'sine', 0.15);
        break;
      case 'bubble':
        ...
        break;
      case 'descend':
        playToneSweep(200, 40, 0.6, 'triangle', 0.2);
        playNoiseHit(0.5, 100, 20, 0.15);
        break;
      case 'bossRoar':
        playNoiseBurst(0.6, 0.35);
        playToneSweep(80, 20, 0.5, 'sawtooth', 0.3);
        break;
      default:
        break;
